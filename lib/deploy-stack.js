...
class DeployStack extends Stack {
	...
	deployBackend() {
		...
		const docExtractor = this.#buildLambda(this, 'extractor-orchestrator', Duration.minutes(2), OutputFormat.ESM)
		this.#bedrockEnabler.grantAccessToModels(docExtractor, getExtractionModelIds())
		...
		this.#bedrockEnabler.grantAccessToModels(this.#skillLambda, [QUERY_CONFIG.modelId])
